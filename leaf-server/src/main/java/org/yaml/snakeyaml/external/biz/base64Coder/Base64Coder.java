...
public class Base64Coder {
    ...
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger("Keila"); // Leaf - Print warning for using deprecated snakeyaml's Base64Coder library
    ...
    private static void warn() {
        if (gg.tame.keila.util.KeilaConstants.ENABLE_BASE64CODER_WARNING) {
