...
public class ExecutorFactory {
    ...
    public static ExecutorService buildAuthPoolExecutor() {
        ...
        if (VirtualThreadSupport.authPool) {
            return new BoundedExecutorService(Executors.newThreadPerTaskExecutor(
                Thread.ofVirtual()
                    ...
                    .factory()
            ), VirtualThreadSupport.authPoolMaxConcurrency);
        }
        ...
        if (VirtualThreadSupport.downloadPool) {
            return new BoundedExecutorService(Executors.newThreadPerTaskExecutor(
                Thread.ofVirtual()
                    ...
                    .factory()
            ), VirtualThreadSupport.downloadPoolMaxConcurrency);
        }
